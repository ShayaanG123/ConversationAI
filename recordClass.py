...
class RecAUD:
    ...
    def __init__(self, filename, chunk=3024, frmat=pyaudio.paInt16, channels=1, rate=44100, py=pyaudio.PyAudio()):
        ...
        self.stop_convo = tkinter.Button(self.buttons, width=10, padx=10, pady=5, text='Stop Conversation', command=self.stop_convo())
        self.stop_convo.grid(row=2, column=0, columnspan=1, padx=50, pady=5)
